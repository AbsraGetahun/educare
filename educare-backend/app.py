...
def generate_practice_material():
    """
    Generate practice material for a student or all students.
    Handles both student_id and grade_level/for_all_students.
    """
    try:
        data = request.get_json() or {}
        ...
        # If for_all_students is true, use grade_level
        if for_all_students and grade_level:
            ...
            return jsonify({
                ...
                "message": f"Material generated for Grade {grade} students",
                "for_all_students": True,
                "generated": 1,
                "total_students": 1,
                "questions_count": 4,
                "questions": [
                    f"Question 1 about {topic_name}",
                    f"Question 2 about {topic_name}",
                    f"Question 3 about {topic_name}",
                    f"Question 4 about {topic_name}"
                ]
            }), 201

        # If student_id is provided, generate for a specific student
        if not student_id:
            return jsonify({"error": "student_id is required"}), 400
